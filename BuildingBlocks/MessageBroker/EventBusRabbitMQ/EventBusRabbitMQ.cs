...
using InMemoryEventBusSubscriptionsManager = Team5.BuildingBlocks.MessageBroker.EventBus.InMemoryEventBusSubscriptionsManager;

namespace Team5.BuildingBlocks.MessageBroker.EventBusRabbitMQ
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        const string BROKER_NAME = "team5_event_bus";
        const string AUTOFAC_SCOPE_NAME = "team5_event_bus";
