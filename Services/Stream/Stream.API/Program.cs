...
using Stream.API.Infrastructure;
    ...
    public class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            try
            {
                ...
                host.MigrateDbContext<StreamContext>((context, services) =>
                {
                    var env = services.GetService<IWebHostEnvironment>();
                    var settings = services.GetService<IOptions<StreamSettings>>();
                    var logger = services.GetService<ILogger<StreamContextSeed>>();
                    
                    new StreamContextSeed()
